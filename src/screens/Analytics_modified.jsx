      ...
      <div className="p-4">
        ...
        {selectedDate != "Dates" && Object.keys(arrangedData).length > 0 && (
          <div className="row m-2 g-4">
            ...
            <div className="col-md-3 m-2" style={{ display: "flex" }}>
              <div className="custom-card">
                ...
                >
                  <div style={{ margin: "0.5rem" }}>
                    ...
                    <div>{responseData?.range[0]["value"][6]}</div>
                  </div>
                </div>
              </div>
              <div className="custom-card">
                ...
                >
                  <div style={{ margin: "0.5rem" }}>
                    ...
                    <div>{responseData?.range[0]["value"][5]}</div>
                  </div>
                </div>
              </div>
              <div className="custom-card">
                ...
                >
                  <div style={{ margin: "0.5rem" }}>
                    ...
                    <div>{responseData?.range[0]["value"][4]}</div>
                  </div>
                </div>
              </div>
              <div className="custom-card">
                ...
                >
                  <div style={{ margin: "0.5rem" }}>
                    ...
                    <div>{responseData?.range[0]["value"][3]}</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="row m-2 g-4">
          <div className="col-md-6">
            <SimpleAnalyticsChart
              ...
              chartFor={["Planned Progress (%)", "Actual Progress (%)"]}
            />
          </div>
          <div className="col-md-6">
            <SimpleAnalyticsChart
